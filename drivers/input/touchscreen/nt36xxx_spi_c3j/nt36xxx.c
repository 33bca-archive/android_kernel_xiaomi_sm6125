...
const uint16_t gesture_key_array[] = {
	KEY_DOUBLE_TAP,  //GESTURE_WORD_C
	KEY_DOUBLE_TAP,  //GESTURE_WORD_W
	KEY_DOUBLE_TAP,  //GESTURE_WORD_V
	KEY_DOUBLE_TAP,  //GESTURE_DOUBLE_CLICK
	KEY_DOUBLE_TAP,  //GESTURE_WORD_Z
	KEY_DOUBLE_TAP,  //GESTURE_WORD_M
	KEY_DOUBLE_TAP,  //GESTURE_WORD_O
	KEY_DOUBLE_TAP,  //GESTURE_WORD_e
	KEY_DOUBLE_TAP,  //GESTURE_WORD_S
	KEY_DOUBLE_TAP,  //GESTURE_SLIDE_UP
	KEY_DOUBLE_TAP,  //GESTURE_SLIDE_DOWN
	KEY_DOUBLE_TAP,  //GESTURE_SLIDE_LEFT
	KEY_DOUBLE_TAP,  //GESTURE_SLIDE_RIGHT
};
#endif
